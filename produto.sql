...
CREATE TRIGGER t_nao_deletar_estoque ON Produto 
FOR DELETE
AS
BEGIN
     IF((SELECT qtd_estoque FROM DELETED) > 0)
	 BEGIN
	     ROLLBACK TRANSACTION
	     RAISERROR('Não se pode deletar o produto pois a quantidade é maior que 0', 16, 1)
	 END
